    ...
    public class IndexModel : PageModel
    {
        ...
        public void OnGet(string query, string categoria)
        {
            ...
            var all = new List<Libro>
            {
                ...
                new Libro { Id = 9, Titulo = "EL HIJO DE NEPTUNO ( LOS HEROES DEL OLIMPO )" , Autor = "Rick Riordan", Imagen = "nepa.jpg", Categoria = "Ficcion"},
                new Libro { Id = 10, Titulo = "AMANECER EN LA COSECHA ( LIBRO 5 DE LOS JUEGOS DEL HAMBRE )" , Autor = "Suzanne Collins", Imagen = "juegos.jpg", Categoria = "Ficcion"},
                new Libro { Id = 11, Titulo = "Los gatos de fortuna", Autor = "Anny Duperey", Imagen = "gatoFortuna.jpg", Categoria = "Ficcion" },
                new Libro { Id = 12, Titulo = "El laberinto en llamas (Las pruebas de apolo libro 3)", Autor = "Rick Riordan", Imagen = "ñasss.jpg", Categoria = "Fantasia" },
                new Libro { Id = 13, Titulo = "Un reino de promesas malditas", Autor = "Lexi Ryan", Imagen = "mald.jpg", Categoria = "Novela" },
                new Libro { Id = 14, Titulo = "La espada de Kuromori", Autor = "Jason Rohan", Imagen = "esp.jpg", Categoria = "Ficcion" },
                new Libro { Id = 15, Titulo = "El veneno del poder", Autor = "Gabriela Cerruti", Imagen = "veneno.jpg", Categoria = "Ficcion Politica"},
                new Libro { Id = 16, Titulo = "Elon Musk", Autor = "Walter Isaacson", Imagen = "elon.jpg", Categoria = "Biografia" },
                new Libro { Id = 17, Titulo = "El crimen de año nuevo", Autor = "Daniel Balmaceda", Imagen = "hhhh.jpg", Categoria = "Policial"},
                new Libro { Id = 18, Titulo = "Alma de gato", Autor = "Ruth Berger", Imagen = "almaGatoo.png", Categoria = "Autoayuda"},
                new Libro { Id = 19, Titulo = "Bajo la misma estrella", Autor = "John Green", Imagen = "mismaEstrella.jpg", Categoria = "Novela" },
                new Libro { Id = 20, Titulo = "Yo antes de ti", Autor = "Jojo Moyes", Imagen = "antesDeTi.jpg", Categoria = "Novela"},
            };
